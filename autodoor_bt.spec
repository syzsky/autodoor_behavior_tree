...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'pythoncom',
        'ctypes',
    ] + collect_submodules('pynput') + collect_submodules('bt_core') + collect_submodules('bt_gui') + collect_submodules('bt_nodes') + collect_submodules('bt_utils') + collect_submodules('rapidocr'),
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[
